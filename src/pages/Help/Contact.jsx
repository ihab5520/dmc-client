          ...
          <MDBRow>
              ...
              <MDBCard>
                <MDBCardBody>
                  ...
                  <form className="form-contact" onSubmit={sendEmail}>
                    ...
                    <div className="md-form">
                      <MDBInputGroup className='mb-3' noBorder textBefore={<MDBIcon fas icon='tag' />}>
                        <MDBInput
                          label="Subject"
                          iconClass="grey-text"
                          type="text"
                    ...
                    <div className="md-form">
                      <MDBInputGroup className='mb-3' noBorder textBefore={<MDBIcon fas icon='pencil-alt' />}>
                        <MDBInput
                          label="Message"
                          iconClass="grey-text"
                          type="textarea"
            ...
            <MDBCol lg="7">
              ...
              <div
                ...
                style={{ height: "400px" }}
              >
                <MapContainer center={[48.8804304958452, 2.3255009016116674]} style={{width:'100%', height:'100%'}} zoom={13} scrollWheelZoom={false}>
                  <TileLayer
                    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                  />
                  <Marker position={[48.8804304958452, 2.3255009016116674]}
                    icon={mapIcon1}
                  >
                    <Popup>
              ...
              <MDBRow className="text-center row-contact">
                ...
                <MDBCol md="6">
                  ...
                  <p className="location-name location-email mt-3"><a href="mailto:ihab.saleh@dmcvoyage.com">ihab.saleh@dmcvoyage.com</a></p>
                </MDBCol>
              </MDBRow>
            </MDBCol>
          </MDBRow>
